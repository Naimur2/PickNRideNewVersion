...
export interface IRideCompleteData {
...
export default function RideCompleteData({
  ...
  const {
    ...
    {
      skip: startLocation?.latitude && startLocation?.longitude ? false : true,
    }
  );
  const {
    data: endPosition,
    ...
    {
      skip: endLocation?.latitude && endLocation?.longitude ? false : true,
    }
  );
    ...
    <VStack bg="white">
      ...
      <HStack mt={4} w="100%" py={4} pr={6}>
        ...
        >
          ...
          <VStack>
            <Text fontWeight={700} fontSize={scale(16)} color={"#fff"}>
              {distanceTravelled} km
            </Text>
            <Text fontWeight={500} fontSize={scale(10)} color={"#fff"}>
              Distance
            </Text>
          </VStack>
        </HStack>
