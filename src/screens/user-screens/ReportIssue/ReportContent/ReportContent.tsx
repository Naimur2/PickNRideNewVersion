  ...
  return (
    ...
    >
      ...
      <Card px="3" shadow="5">
        ...
        />
        {formik.errors.customerMessage && formik.touched.customerMessage ? (
          <Text color="red.500" fontSize={12} fontWeight={500}>
      ...
      {isOpen ? (
        <CModal isOpen={isOpen} onClose={() => setIsOpen(false)} py={8}>
          ...
          <Text
            ...
            color="gray.100"
          >
            <Text color={"primary.100"}>support@pickandride.qa</Text> or
            alternatively filling out the same form.
          </Text>
        </CModal>
      ) : null}
    </VStack>
